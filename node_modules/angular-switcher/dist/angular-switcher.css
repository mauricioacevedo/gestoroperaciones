...
.switcher-line { position: relative; width: 30px; height: 2em; margin: 0 8px; }
...
.switcher-line:after { content: ''; display: block; width: 18px; height: 18px; background: #ff5050; border: 1px solid #c9d1d6; box-shadow: 0 1px 2px rgba(97, 126, 147, .5);
	left: 0; }
...
.switcher.active .switcher-label.true { color: #ff5050; }
