...
//--------------------------demepedido activacion----------------------
   ...
   if($tabla=='ACTIVADOR_SUSPECORE'){
            ...
            $sqlupdate="update gestor_activacion_pendientes_activador_suspecore set ASESOR='$user',VIEWS=VIEWS+1 where ID in ($ids) and pedido='$mypedido'";
        }else {
            $sqlupdate="update gestor_activacion_pendientes_activador_dom set ASESOR='$user',VIEWS=VIEWS+1 where ID in ($ids) and pedido='$mypedido'";
        }
