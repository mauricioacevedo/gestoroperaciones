...
//-----------------------------fin extortar activacion GTC---------------------------------
    ...
    private function csvListadoActivacion(){
        ...
        if($r->num_rows > 0){
            ...
            fputcsv($fp, array( 'ORDER_SEQ_ID','PEDIDO','ESTADO','FECHA_CREACION','FECHA_EXCEPCION','TRANSACCION','PRODUCTO','ASESOR','FECHA_GESTION','TIPIFICACION','FECHA_INICIO','FECHA_FIN','TIEMPO_SISTEMA','DURACION'));
...
//--------------------------demepedido activacion----------------------
    private function demePedidoActivacion(){
        ...
        */
        ...
        $query1=" SELECT b.ID ".
            " ,b.PEDIDO,b.ORDER_SEQ_ID,b.ESTADO,b.TAREA_EXCEPCION,b.IDSERVICIORAIZ,b.TRANSACCION,b.STATUS,b.ASESOR,b.MOTIVOEXCEPCIONACT,b.DESCRIPCIONEXCEPCIONACT  ".
