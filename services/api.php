...
if($novedad=='AGENDADO'||$novedad=='AGENDADO MANUAL'||$novedad=='AGENDADO_FUTURO'|| $novedad=='NO CONOCE EL PEDIDO'|| $novedad=='SIN CITA'|| $novedad=='PENDIENTE EN OTRO CONCEPTO'|| $novedad=='NO DESEA EL SERVICIO'|| $novedad=='YA ESTA CUMPLIDO'|| $novedad=='LIBERACION DE CUPOS' || $novedad=='CONFIRMA SOLUCION' ){
				       ...
				       ||$novedad=='YA ESTA CUMPLIDO–CERRADO' ||$novedad=='YA ESTA CUMPLIDO–PENDIENTE'||$novedad=='PENDIENTE RECONFIGUAR PEDIDO' ||$novedad=='ANULADO AXGAR' || $novedad=='ANULADO APRCT' ||$novedad=='PENDIENTE OTRO CONCEPTO' || $novedad=='NO DESEA EL SERVICIO' || $novedad=='YA ESTA CUMPLIDO'){
