...
*/
                $sqldatos="insert into gestor_historico_activacion (ORDER_SEQ_ID,PEDIDO,REFERENCE_NUMBER,ESTADO,FECHA_EXCEPCION,PRODUCTO,TRANSACCION,ASESOR,TIPIFICACION,SOURCE,FECHA_INICIO,FECHA_FIN) values ($guardar,'MANUAL',$date,$date)";
