...
//---------------------insert pedido reagendamiento--------------------agendamiento-------------
    ...
    private function insertPedidoReagendamiento(){
        ...
        if($novedad=='AGENDADO'||$novedad=='AGENDADO MANUAL'|| $novedad=='NO CONOCE EL PEDIDO'|| $novedad=='SIN CITA'|| $novedad=='PENDIENTE EN OTRO CONCEPTO'|| $novedad=='NO DESEA EL SERVICIO'|| $novedad=='YA ESTA CUMPLIDO'|| $novedad=='LIBERACION DE CUPOS' || $novedad=='CONFIRMA SOLUCION' || $novedad=='CONFIRMADA' || $novedad=='CONFIRMADA-DATOS ERRADOS'){
            ...
            || $novedad=='PENDIENTE EN OTRO CONCEPTO' || $novedad=='NO DESEA EL SERVICIO' || $novedad=='YA ESTA CUMPLIDO' || $novedad=='AGENDADO_FUTURO'){
