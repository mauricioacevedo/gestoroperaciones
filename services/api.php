...
//------------------------------------------exportar listado activacion tipo trabajo=nuevo---------activacion
    ...
    private function csvListadoActivacionnuevos(){
        ...
        if($r->num_rows > 0){
            ...
            fputcsv($fp, array( 'ID','PEDIDO_ID','SUBPEDIDO_ID','SOLICITUD_ID','CONCEPTO_ID','COLA_ID','ACTIVIDAD_ID','TIPO_TRABAJO','USUARIO_ID','FECHA_ENTRADA_GESTOR','FECHA_ULTIMA_GESTOR'));
