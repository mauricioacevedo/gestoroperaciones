...
app.run(function ($rootScope, $compile, $window, notify, services) {
	...
	$rootScope.BuscaGPON = function () {
		$window.open(window.location.pathname + "#/gpon/", "Buscar Nodo GPON", "target _blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=50, left=50, width=1100, height=450");
	};
