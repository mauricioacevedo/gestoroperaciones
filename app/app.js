var app = angular.module('myApp', ['base64','ngRoute','ngCookies','ng-fusioncharts','ngAnimate','ui.bootstrap','ui.tinymce','ngSanitize','ui.calendar','angularFileUpload','ui.select']);
...
// -----------------------------BuscarPedido------------------------------------
	...
	$scope.guardar=function(InfoPedido,gestion,status){
		...
		$scope.InfoGestion={
			...
			PEDIDO:$scope.peds[0].ORDER_SEQ_ID,
            REFERENCE_NUMBER:$scope.peds[0].ORDER_SEQ_IDREFERENCE_NUMBER,
			ESTADO:$scope.peds[0].ORDER_SEQ_ID.ESTADO,
            FECHA_CREACION:$scope.peds[0].ORDER_SEQ_ID.FECHA_CREACION,
			TAREA_EXCEPCION:$scope.peds[0].ORDER_SEQ_ID.TAREA_EXCEPCION,
            FECHA_EXCEPCION:$scope.peds[0].ORDER_SEQ_ID.FECHA_EXCEPCION,
			PRODUCTO:$scope.peds[0].ORDER_SEQ_ID.PRODUCTO,
            IDSERVICIORAIZ:$scope.peds[0].ORDER_SEQ_ID.IDSERVICIORAIZ,
			TRANSACCION:$scope.peds[0].ORDER_SEQ_ID.TRANSACCION,
            CODIGO_CIUDAD:$scope.peds[0].ORDER_SEQ_ID.CODIGO_CIUDAD,
			CAMPO_ERROR:$scope.peds[0].ORDER_SEQ_ID.CAMPO_ERROR,
			ASESOR:$scope.peds[0].ORDER_SEQ_ID.ASESOR,
            FECHA_GESTION:$scope.peds[0].ORDER_SEQ_ID.FECHA_GESTION,
            STATUS:$scope.peds[0].ORDER_SEQ_ID.STATUS,
			}
