    ...
    obj.pendientesPorConceptoColaActivacion  = function(){//perdientes por conceptos activacion
     ...
     obj.getDashboardActivacionMes = function(){//grafica activacion mes
       ...
       obj.getSeguimientoActivacionGraficaAD = function(){//grafica activacion seguimiento
        ...
        obj.demePedidoActivacion = function(user,pedido,transaccion,pedido_actual){//deme pedido activacion
            //console.log("user="+user+",pedido="+pedido);
		return $http.get(serviceBase+'demePedidoActivacion?pedidoID='+pedido+'&userID='+user+ '&transaccion='+transaccion+'&pedido_actual='+pedido_actual);
    	}
...
// -----------------------------BuscarPedido------------------------------------
	...
	$scope.guardar=function(InfoPedido,gestion,status){
		...
		$scope.InfoGestion={
            ...
            TIPIFICACION:gestion.TIPIFICACION,
			}
